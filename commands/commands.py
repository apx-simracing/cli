...
from commands.chat import chat_command, kick_command, add_bot_command, restart_weekend_command,  restart_race_command, restart_race_command, next_session_command, rejoin_driver_command
from commands.deployment import deploy_command, install_command, unlock_command
from commands.build import build_skin_command, get_config_command, get_ports_command, stamp_command
from commands.results import get_results_command, process_results_command, update_results_command
from commands.util import get_rfcmp_info_command, get_components_in_directory_command, check_config_command
